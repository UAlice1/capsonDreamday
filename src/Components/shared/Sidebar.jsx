...
export default function Sidebar() {
    return (
        <div className="bg-blue-400 w-60 p-3 flex flex-col">
            <div className="flex items-center gap-2 px-1 py-3">
                <BiSolidDonateHeart fontSize={24} />
                <span className="text-neutral-200 text-lg">Dream Day Rentals</span>
            </div>
            ...
            <div className="flex flex-col gap-0.5 pt-2 border-t border-white">
                ...
                <div className={classNames(linkClass, 'cursor-pointer text-slate-300')}>
...
function SidebarLink({ link }) {
    ...
    return (
        <Link
            to={link.path}
            className={classNames(pathname === link.path ? 'bg-blue-500 text-white' : 'text-neutral-400', linkClass)}
        >
